import {
  ...
  HOOKS
} from "./chunk-PK27LKU3.js";
import {
  useNpsSurveySettings
} from "./chunk-PLY6W7OU.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-Z5WUDPAI.js";
import {
  useGetAIUsageQuery
} from "./chunk-ENKJ63UP.js";
import {
  _setPrototypeOf
...
import {
  ...
  require_merge,
  require_omit
} from "./chunk-6XLAJBHZ.js";
import {
  require_baseRest
} from "./chunk-77XNHWK7.js";
import {
  require_pick
} from "./chunk-MY5722WP.js";
import {
  HistoryProvider
} from "./chunk-BDS2IHPP.js";
import {
  useEnterprise
} from "./chunk-FOK5W6R7.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-JI2WKNQR.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-B2ZGFOZS.js";
import {
  Login
} from "./chunk-BJSHPXT7.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-G4MN2JBC.js";
import {
  MemoizedInputRenderer
} from "./chunk-7IAV54DH.js";
import {
  Form
} from "./chunk-5MQPPPS2.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-EHEZMMTI.js";
import {
  ConfigurationProvider
} from "./chunk-SFWVBYNH.js";
import {
  Layouts
} from "./chunk-7LQTVXLP.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-ZFQ4Z6NQ.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-TBUOWLHV.js";
import {
  getByteSize
...
import {
  require_isEqual
} from "./chunk-MAUJL7NY.js";
import {
  Page,
  l1,
  useAPIErrorHandler
} from "./chunk-XBZNN3WV.js";
import {
  AuthProvider,
  StrapiAppProvider,
  getOrCreateDeviceId,
...
// node_modules/@strapi/admin/node_modules/lodash/_customDefaultsMerge.js
var require_customDefaultsMerge = __commonJS({
  "node_modules/@strapi/admin/node_modules/lodash/_customDefaultsMerge.js"(exports, module2) {
...
// node_modules/@strapi/admin/node_modules/lodash/mergeWith.js
var require_mergeWith = __commonJS({
  "node_modules/@strapi/admin/node_modules/lodash/mergeWith.js"(exports, module2) {
    var baseMerge = require_baseMerge();
...
// node_modules/@strapi/admin/node_modules/lodash/defaultsDeep.js
var require_defaultsDeep = __commonJS({
  "node_modules/@strapi/admin/node_modules/lodash/defaultsDeep.js"(exports, module2) {
...
// node_modules/@strapi/admin/node_modules/lodash/now.js
var require_now = __commonJS({
  "node_modules/@strapi/admin/node_modules/lodash/now.js"(exports, module2) {
...
// node_modules/@strapi/admin/node_modules/lodash/debounce.js
var require_debounce = __commonJS({
  "node_modules/@strapi/admin/node_modules/lodash/debounce.js"(exports, module2) {
    var isObject = require_isObject();
    var now = require_now();
...
// node_modules/@strapi/admin/node_modules/lodash/throttle.js
var require_throttle = __commonJS({
  "node_modules/@strapi/admin/node_modules/lodash/throttle.js"(exports, module2) {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-JLIARCVU.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-Q7NYH3HR.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-6JEAPQZ5.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-OVQASW35.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-2ZNM5YMV.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-DBR6BTYA.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-ZWR47AW3.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-ILIFAJUW.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-OZOAOWFF.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-YAL2QDNU.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-UPLYTCVC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-WQWSKFEM.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-VZ53NLFV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-UZQOEZIP.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-MWWMLR44.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-OAMUEAZC.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-GRXQ6CDA.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-TQATZYWD.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-ZW7BIOHF.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-2RJZ6RVE.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-BLTU2HGG.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-GRFDJN3R.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-WCJZT46Z.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-X5IPN2VM.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-ISGD5UHM.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-MEMZF4JW.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-OIQOYUVQ.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-XYU743XF.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-MA2VKV5T.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-MA2VKV5T.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-W6HM76RP.js");
...
//# sourceMappingURL=chunk-VGEXYAR3.js.map
