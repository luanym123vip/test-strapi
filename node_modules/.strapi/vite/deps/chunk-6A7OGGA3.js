...
import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-KNQXC3U5.js";
import {
  getStageColorByHex
} from "./chunk-7FYMQILG.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-YLCUW23U.js";
import {
  index
} from "./chunk-ECIUR6CA.js";
import {
...
import {
  ...
  useGetReleasesQuery
} from "./chunk-KPD4T633.js";
import {
  LimitsModal
} from "./chunk-KMF3RWNZ.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-SSOC6ETA.js";
import {
  useConfig
} from "./chunk-7VTTTYY3.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-N4RKPAYY.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-AE7NXKSG.js";
import {
  renderAdmin
} from "./chunk-VGEXYAR3.js";
import {
  useAIAvailability
...
import {
  useLicenseLimits
} from "./chunk-Z44OJZ7P.js";
import {
  Table,
  useTable
} from "./chunk-DYKK65S4.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3
...
import {
  useAdminUsers
} from "./chunk-YQ5CY5SM.js";
import {
  useRBAC
} from "./chunk-6FP5WLW2.js";
import {
  K,
  Page,
  useAPIErrorHandler
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-2W7IFTBQ.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-5KQOQ4D2.js").then((mod) => ({
...
var HeaderStatusMessage = ({ title, subtitle }) => {
  return (0, import_jsx_runtime16.jsxs)(T, {
    ...
    paddingLeft: 2,
    children: [
      (0, import_jsx_runtime16.jsx)($5d3850c4d0b4e6c7$export$f99233281efd08a0, {
        children: (0, import_jsx_runtime16.jsx)(I, {
          variant: "omega",
          children: title
        })
      }),
      (0, import_jsx_runtime16.jsx)($5d3850c4d0b4e6c7$export$393edc798c47379d, {
        children: (0, import_jsx_runtime16.jsx)(I, {
          variant: "pi",
          textColor: "neutral600",
          children: subtitle
...
`;
var HeaderStatusWrapper = ct($5d3850c4d0b4e6c7$export$f99233281efd08a0)`
  display: flex;
  align-items: center;
`;
    ...
    children: [
      ...
      (0, import_jsx_runtime16.jsxs)(T, {
        ...
        children: [
          ...
          isComplete && (0, import_jsx_runtime16.jsx)(HeaderIconButton, {
            onClick: handleClose,
            label: formatMessage({
...
var DialogContent = ct($5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2)`
  position: fixed;
...
var UploadProgressDialog = () => {
  ...
  return (0, import_jsx_runtime16.jsx)($5d3850c4d0b4e6c7$export$be92b6f5f03c0fe9, {
    open: isVisible,
    modal: false,
    children: (0, import_jsx_runtime16.jsx)($5d3850c4d0b4e6c7$export$602eac185826482c, {
      children: (0, import_jsx_runtime16.jsxs)(DialogContent, {
        ...
        children: [
          ...
          (0, import_jsx_runtime16.jsx)(AnimatedContent, {
            $isVisible: !isMinimized,
            children: (0, import_jsx_runtime16.jsx)(R, {
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-K3A2O7GO.js");
    case "./translations/es.json":
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-TCAIB2B4.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-6YGV2DUW.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-65LVJLIZ.js");
        return {
...
var CheckboxConfirmation = ({ description, isCreating = false, intlLabel, name: name2, onChange, value }) => {
  ...
  return (0, import_jsx_runtime17.jsxs)(_m.Root, {
    ...
    children: [
      (0, import_jsx_runtime17.jsxs)(Hm.Root, {
        hint,
        name: name2,
        children: [
          (0, import_jsx_runtime17.jsx)(Tr, {
            onCheckedChange: handleChange,
            checked: value,
            children: label
          }),
          (0, import_jsx_runtime17.jsx)(Hm.Hint, {})
        ]
      }),
              ...
              children: rows.map(({ locale, status }, index4) => {
                ...
                return status && locale ? (0, import_jsx_runtime18.jsxs)(Table.Row, {
                  children: [
                    ...
                    (0, import_jsx_runtime18.jsx)(Table.Cell, {
                      children: (0, import_jsx_runtime18.jsx)(ot, {
                        tag: Link,
                        to: {
          ...
          (0, import_jsx_runtime19.jsx)(_m.Body, {
            children: (0, import_jsx_runtime19.jsxs)(T, {
              ...
              children: [
                ...
                (0, import_jsx_runtime19.jsxs)(Hm.Root, {
                  width: "100%",
                  children: [
                    (0, import_jsx_runtime19.jsx)(Hm.Label, {
                      children: formatMessage({
                        id: getTranslation("CMEditViewCopyLocale.dialog.field.label"),
                        defaultMessage: "Locale"
                      })
                    }),
                    (0, import_jsx_runtime19.jsx)(yo, {
                      ...
                      children: availableLocales.map((locale) => (0, import_jsx_runtime19.jsx)(wo, {
                        value: locale.code,
                        children: locale.name
                      }, locale.code))
                    })
...
var LocalePicker = () => {
  ...
  const sortedLocaleOptions = React14.useMemo(() => {
    ...
    return displayedLocales.sort((a, b) => a.name.localeCompare(b.name)).map((locale) => (0, import_jsx_runtime21.jsx)(wo, {
      value: locale.code,
      children: locale.name
    }, locale.id));
  }, [
  ...
  return (0, import_jsx_runtime21.jsx)(yo, {
    size: "S",
    "aria-label": formatMessage({
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-POUDYSGL.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
                ...
                children: (0, import_jsx_runtime26.jsxs)(T, {
                  ...
                  children: [
                    (0, import_jsx_runtime26.jsx)(R, {
                      paddingBottom: 6,
                      children: (0, import_jsx_runtime26.jsxs)(Hm.Root, {
                        required: true,
                        children: [
                          (0, import_jsx_runtime26.jsx)(Hm.Label, {
                            children: formatMessage({
                              id: "content-releases.content-manager-list-view.add-to-release.select-label",
                              defaultMessage: "Select a release"
                            })
                          }),
                          (0, import_jsx_runtime26.jsx)(yo, {
                            placeholder: formatMessage({
                            ...
                            value: values.releaseId,
                            children: releases == null ? void 0 : releases.map((release) => (0, import_jsx_runtime26.jsx)(wo, {
                              value: release.id,
                              children: release.name
                            }, release.id))
                          })
      ...
      (0, import_jsx_runtime27.jsx)(c1.Content, {
        children: (0, import_jsx_runtime27.jsx)("ul", {
          children: releases.map(({ id, name: name2 }) => (0, import_jsx_runtime27.jsx)(R, {
            padding: 3,
            tag: "li",
            children: (0, import_jsx_runtime27.jsx)(Wc, {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-S33GLMAB.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-BR6RV7P3.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-7JXMRPLR.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-L67JODED.js");
          return {
...
var AssigneeSelect = ({ isCompact }) => {
  ...
  if (isCompact) {
    return (0, import_jsx_runtime29.jsxs)(Hm.Root, {
...
var Select = ({ stages, activeWorkflowStage, isLoading, ...props }) => {
  ...
  return (0, import_jsx_runtime30.jsx)(yo, {
    ...
    customizeContent: () => {
      return (0, import_jsx_runtime30.jsxs)(T, {
        ...
        children: [
          ...
          isLoading ? (0, import_jsx_runtime30.jsx)(Vd, {
            small: true,
            style: {
              display: "flex"
            },
...
var StageSelect = ({ isCompact }) => {
  ...
  if (isCompact) {
    return (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, {
      children: [
        (0, import_jsx_runtime30.jsx)(Ar, {
          label: reviewStageHint,
          children: (0, import_jsx_runtime30.jsx)(Hm.Root, {
            name: STAGE_ATTRIBUTE_NAME,
            id: STAGE_ATTRIBUTE_NAME,
            children: (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, {
              children: [
                (0, import_jsx_runtime30.jsx)(lt, {
                  children: (0, import_jsx_runtime30.jsx)(Hm.Label, {
  ...
  return (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, {
    children: [
      (0, import_jsx_runtime30.jsxs)(Hm.Root, {
        ...
        children: [
          ...
          (0, import_jsx_runtime30.jsx)(Hm.Hint, {}),
          (0, import_jsx_runtime30.jsx)(Hm.Error, {})
        ]
      }),
      (0, import_jsx_runtime30.jsx)(WorkflowLimitModal, {
        open: showLimitModal === "workflow",
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-QYLBJM22.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-PTRCJ33V.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-SSNS2U3Z.js");
          return {
...
//# sourceMappingURL=chunk-6A7OGGA3.js.map
